...
import { documentArchiveSchema, documentArchiveSchemaPartial, pdfFileSchema } from '@/validations/documentArchiveValidation';
...
router.put('/:id', verifyToken, upload.single("file"), validate(documentArchiveSchemaPartial, pdfFileSchema), documentArchiveController.updateDocumentArchive)
